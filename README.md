...
AI Engineer in Alexandria, Egypt, working in computer vision and deep learning.
...
Weekly sales forecasting across 45 Walmart stores — XGBoost at **$84K MAE**, plus a stacked ensemble for demand prediction. Streamlit app, Docker deployment.

**Stack:** Python · PyTorch · TensorFlow · Hugging Face Transformers · OpenCV · scikit-learn · XGBoost · Docker · Streamlit
